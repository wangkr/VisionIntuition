...
public class GPUImageLomofiFilter extends GPUImageTwoTextureFilter
{
    ...
    private void setRes()
    {
        ...
        arrayOfBitmap[0] = BitmapFactory.decodeResource(this.context.getResources(), R.mipmap.nmap);
        arrayOfBitmap[1] = BitmapFactory.decodeResource(this.context.getResources(), R.mipmap.nblowout);
