...
public class GPUImageValenciaFilter extends GPUImageTwoTextureFilter
{
    ...
    private void setRes()
    {
        ...
        arrayOfBitmap[0] = BitmapFactory.decodeResource(this.context.getResources(), R.mipmap.valencia_map);
        arrayOfBitmap[1] = BitmapFactory.decodeResource(this.context.getResources(), R.mipmap.valencia_gradient_map);
