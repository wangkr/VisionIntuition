...
public class GPUImageWaldenFilter extends GPUImageTwoTextureFilter
{
    ...
    private void setRes()
    {
        ...
        arrayOfBitmap[0] = BitmapFactory.decodeResource(this.context.getResources(), R.mipmap.walden_map);
        arrayOfBitmap[1] = BitmapFactory.decodeResource(this.context.getResources(), R.mipmap.vignette_map);
