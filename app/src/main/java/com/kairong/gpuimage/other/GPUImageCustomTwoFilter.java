package com.kairong.gpuimage.other;
...
public class GPUImageCustomTwoFilter extends GPUImageFourTextureFilter
{
    ...
    private void setRes()
    {
        ...
        arrayOfBitmap[0] = BitmapFactory.decodeResource(this.context.getResources(), R.mipmap.toaster_soft_light);
        arrayOfBitmap[1] = BitmapFactory.decodeResource(this.context.getResources(), R.mipmap.toaster_curves);
        arrayOfBitmap[2] = BitmapFactory.decodeResource(this.context.getResources(), R.mipmap.toaster_overlay_map_warm);
        arrayOfBitmap[3] = BitmapFactory.decodeResource(this.context.getResources(), R.mipmap.toaster_color_shift);
