...
/**
 * Created by Kairong on 2015/8/11.
...
import com.kairong.gpuimage.filter.*;
import com.kairong.vision_recognition.R;

public class GPUImageFilterTools {
    public static void onChooseFilter(final Context context,int item,
                                  final OnGpuImageFilterChosenListener listener) {
        final FilterList filters = new FilterList();
        filters.addFilter("Amatorka", FilterType.LOOKUP_AMATORKA);
